...
import { buildFeedSearchSuggestions, eventMatchesFeedQuery, splitFeedQueryTerms, } from '../../src/features/home/feedSearch';
function makeEvent(id, content, hashtags, author) {
    return {
        id,
        pubkey: author,
